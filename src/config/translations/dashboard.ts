...
export const dashboard = createI18n(provider, {
  en: {
    ...
    invite: {
      title: 'Invite Static Bot',
      description: 'Try our discord bot with one-click',
      bn: 'Invite now',
    },
    servers: {
      title: 'Select Yoyr Discord Server',
      description: 'Select the server to configure the bot',
    },
    vc: {
      create: 'Create a voice channel in your server',
      'created channels': 'Created Voice channels',
    },
    command: {
      title: 'Command Usage',
      description: 'Use of commands in your server',
    },
  },
  cn: {
    pricing: '價錢',
